                            ...
                            net_addr_t *addr)
{
    ...
    if (data.gamemode != sv_gamemode || data.gamemission != sv_gamemission)
    {
        ...
        M_snprintf(msg, sizeof(msg),
                   ...
                   D_GameMissionString((GameMission_t)sv_gamemission),
                   D_GameModeString((GameMode_t)sv_gamemode),
                   D_GameMissionString((GameMission_t)data.gamemission),
                   D_GameModeString((GameMode_t)data.gamemode));
...
static void NET_SV_ParseGameStart(net_packet_t *packet, net_client_t *client)
{
    ...
    if (client == NET_SV_Controller())
    {
        ...
        if (!NET_ValidGameSettings((GameMode_t)sv_gamemode, (GameMission_t)sv_gamemission, &settings))
        {
