...
{ 
    ...
    sprites = Z_Malloc<decltype(*sprites)>(numsprites *sizeof(*sprites), PU_STATIC, NULL);
	...
	sprites[i].spriteframes = Z_Malloc<decltype(*sprites[0].spriteframes)> (maxframe * sizeof(spriteframe_t), PU_STATIC, NULL);
