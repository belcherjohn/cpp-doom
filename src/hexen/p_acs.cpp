...
void P_LoadACScripts(int lump)
{
    ...
    ACSInfo = Z_Malloc<decltype(*ACSInfo)>(ACScriptCount * sizeof(acsInfo_t), PU_LEVEL, 0);
    ...
    ACStrings = Z_Malloc<decltype(*ACStrings)>(ACStringCount * sizeof(char *), PU_LEVEL, NULL);
...
static void StartOpenACS(int number, int infoIndex, int offset)
{
    ...
    script = Z_Malloc<decltype(*script)>(sizeof(acs_t), PU_LEVSPEC, 0);
